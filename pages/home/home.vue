	...
	<view>
		...
		<swiper autoplay :interval="3000" :duration="1000" :circular="true" indicator-dots
			...
			<swiper-item v-for="(item, index) in swiperList" :key="index">
				<navigator class="swiper-item" @click="swiperGoTo(item.goods_id)">
		...
		<!-- 分类导航区域 -->
		<view class="nav-list">
			<view class="nav-item" v-for="(item, i) in navList" :key="i" @click="navClickHandler(item.name)">
